import { manAvatar, maleNames, messages, dates } from '@/data/chatData'
...
export function generateManObject(count: number): personaTypes[] {
  const shuffledAvatars = shuffleArray(manAvatar)
  const shuffledNames = shuffleArray(maleNames)
